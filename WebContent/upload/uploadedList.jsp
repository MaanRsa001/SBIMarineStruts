...
<body>
	...
	<div class="table0" style="width: 90%; margin: 0 auto;">
		...
		<div class="tablerow" align="center">
			<s:form name="Uploaded" action="" theme="simple" >
			<div class="panel panel-primary">
				<div class="panel-heading">
					<s:text name="Uploaded Policies"/>				
				</div>
			...
			<script type="text/javascript">    
 		    function getBack()
		    {
		    	document.Uploaded.action = 'transactionListOpenUpload.action';
