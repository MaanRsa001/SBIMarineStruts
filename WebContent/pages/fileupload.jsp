							...
							<div class="box effect8" style="margin-top: 0px;">
								<div class="row" align="center" id="divUpload">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="textV">
											<s:text name="Broker Code" />
										</div>
										<div class="tboxV">
											<s:property value="#session.brokerId" />
										</div>
									</div>
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="textV">
											<s:text name="Customer Id" />
										</div>
										<div class="tboxV">
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class="tboxV">
											<s:property value="#session.openCoverNo" />
										</div>
									</div>
								</div>
								<br />
...
<script type="text/javascript">
	...
	function next() {
		document.form.action = "${pageContext.request.contextPath}/initDeclaration.action";
