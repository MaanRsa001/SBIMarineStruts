    ...
    <div class="easyui-layout" style="width:100%;height:1000px;">
       <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
		...
		<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
			<div class="panel panel-primary">
			   <div class="panel-heading"><s:text name="Tolerance Master"/></div>
				  <div class="panel-body">
																	...
																	<tr>
																	  ...
																	  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
																		<tr>
																			...
																			<td style="width:70%;">
																				<s:textfield name="toleName" id="toleName" cssClass="inputBox form-control" cssStyle="width:51%;" maxlength="25"/> 
																		...
																		<tr>
																			...
																			<td>
																				<s:textfield name="toleValue" id="toleValue" cssClass="inputBox form-control" cssStyle="width:51%;" maxlength="6" onkeypress="return fun_AllowOnlyAmountAndDot(this.id)"/>
																		...
																		<tr>
																			<td>&nbsp;</td> 
																			<td></td>
																			<td colspan="4"><input type="button" class="btn btn-sm btn-danger" value="Back" onclick="fnCall('tolerancemaster')"/>&nbsp;&nbsp;<s:submit value="Save" cssClass="btn btn-sm btn-success" onclick="return oncheck()"/></td>
