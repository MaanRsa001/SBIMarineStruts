...
<style>
    ...
    <div class="easyui-layout" style="width:100%;height:1000px;">
		...
		<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
			<div class="panel panel-primary">
			   <div class="panel-heading"><s:text name="Warranty Master"/></div>
				  <div class="panel-body">
															 ...
															 <table width="100%" border="0" cellspacing="0" cellpadding="0">
																	...
																	<tr>
																	  ...
																	  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
																		<tr>
																			<td>&nbsp;</td>
																			<td width="30%"><s:text name="warranty.name"/><font color="red">*</font> </td>
																			<td width="70%">
																			<s:textarea name="warrantyDesc" id="warrantyDesc" cssClass="inputBoxA form-control"  cssStyle="width:51%;"  maxlength="1500" />
																		...
																		<tr>	
																			...
																			<td></td>															
																			<td colspan="4">
																				<input type="button" class="btn btn-sm btn-danger" value="Back" onclick="fnCall('warrantymaster')"/>&nbsp;&nbsp;<s:submit value="Save" cssClass="btn btn-sm btn-success" onclick="return oncheck()"/>
																			</td>
																		</tr>															
																	 </table></td>
																	 </tr>
