...
td, th {
    ...
    <div class="easyui-layout" style="width:100%;height:1000px;">
		...
		<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
			<div class="panel panel-primary">
			   <div class="panel-heading"><s:text name="Sale Term Master"/></div>
				  <div class="panel-body">
			                                                        ...
			                                                        <tr>
			                                                          ...
			                                                          <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
			                                                            ...
			                                                            <tr>
			                                                                ...
			                                                                <td style="width:70%;">
			                                                                    <s:textfield name="saleName" cssClass="inputBox form-control" cssStyle="width:51%;" id="saleName" maxlength="25"/>
			                                                            ...
			                                                            <tr>
			                                                                ...
			                                                                <td>
			                                                                    <s:textfield name="saleValue" cssClass="inputBox form-control" cssStyle="width:51%;" id="saleValue" maxlength="6" onkeypress="return fun_AllowOnlyAmountAndDot(this.id)"/>
			                                                            ...
			                                                            <tr>
			                                                            	<td>&nbsp;</td> 
																			<td></td>
			                                                                <td colspan="4"><input type="button" class="btn btn-sm btn-danger" value="Back" onclick="fnCall('saletermmaster')"/>&nbsp;&nbsp;<s:submit value="Save" cssClass="btn btn-sm btn-success" onclick="return oncheck()"/></td>
