...
<style>
    ...
    <div class="easyui-layout" style="width:100%;height:1000px;border: 1px;border-color: red;">
		...
		<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
			<div class="panel panel-primary">
			   <div class="panel-heading"><s:text name="Wsrcc Cover"/></div>
				  <div class="panel-body">
																	...
																	<tr>
																	  ...
																	  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
																		<tr>
																			...
																			<td width="70%">
																			   <s:select name="transID" id="transID" cssClass="inputBoxS form-control" cssStyle="width: 64%;" headerKey="transID" headerValue="--Select--" list="transports" listKey="MODE_TRANSPORT_ID" listValue="TRANSPORT_DESCRIPTION" onchange="callCover(this.value,'covername')"/>
																		...
																		<tr>
																			...
																			<td id="covername">
																			<s:select name="covername" id="covername" cssClass="inputBoxS form-control" cssStyle="width: 64%;" headerKey="-1" headerValue="-- Select --" list="coverNames" listKey="COVER_ID" listValue="COVER_NAME" theme="simple" />
																			</td>
																			<td>&nbsp;</td>
																		...
																		<tr>
																			...
																			<td>
																				<s:textarea name="wsrccdesc" id="wsrccdesc" cssClass="inputBoxA form-control" cssStyle="width: 64%" rows="2"/>
																			</td>
																			<td>&nbsp;</td>
																		...
																		<tr>
																			...
																			<td>
																				<s:textfield name="rsacode" id="rsacode" cssClass="inputBox form-control" cssStyle="width: 64%;" maxlength="10"/>
																			</td>
																			<td>&nbsp;</td>
																		...
																		<tr>
																			...
																			<td>
																				<s:textfield name="displayorder" id="displayorder" maxlength="5" cssClass="inputBox form-control" cssStyle="width: 64%;" onkeypress="return isNumberKey(event)"/>
																		...
																		<tr>
			                                                                ...
			                                                                <td>
			                                                                    <s:textfield name="remarks" id="remarks" cssClass="inputBox form-control" cssStyle="width: 64%;" maxlength="80" />
			                                                                </td>
			                                                                <td>&nbsp;</td>
																		...
																		<tr>
																			...
																			<td>
																				...
																				<div id="wordingUpload" style="display: none;">
																					<s:file name="upload" id="upload" cssClass="inputBox form-control" cssStyle="width: 64%;height:32px;"/>
																				</div>
																		...
																		<tr>
																			<td>&nbsp;</td> 
																			<td></td>
																			<td colspan="4"><input type="button" class="btn btn-sm btn-danger" value="Back" onclick="fnCall('wsrcc')"/>&nbsp;&nbsp;<s:submit value="Save" cssClass="btn btn-sm btn-success" onclick="return oncheck()"/></td>
