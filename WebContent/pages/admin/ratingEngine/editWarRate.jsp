...
td, th {
    ...
    <div class="easyui-layout" style="width:100%;height:1000px;">
		...
		<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
			<div class="panel panel-primary">
			   <div class="panel-heading"><s:text name="War Rate Master"/></div>
				    <div class="panel-body">
				                                                          ...
				                                                          <s:if test="mode=='edit'">
				                                                            <tr>
				                                                                ...
				                                                                <td width="45%">
				                                                                    ...
				                                                                    <s:select name="transID" id="transID" list="transports" listKey="MODE_TRANSPORT_ID" listValue="TRANSPORT_DESCRIPTION" headerKey="-1" headerValue="---Select---" disabled="true" cssClass="inputBoxS" cssStyle="width: 51%;" />
				                                                                </td>
				                                                                <td width="5%">&nbsp;</td>
				                                                            </tr>
				                                                           </s:if>
				                                                           <s:else>
				                                                            <tr>
				                                                                ...
				                                                                <td style="width:70%;">
				                                                                    <s:select name="transID" id="transID" list="transports" listKey="MODE_TRANSPORT_ID" listValue="TRANSPORT_DESCRIPTION" headerKey="-1" cssClass="inputBoxS form-control" cssStyle="width:51%;" headerValue="-Select-"/>
				                                                            ...
				                                                            <tr>
				                                                                ...
				                                                                <td>
				                                                                    <s:textfield name="warName" readonly="" id="warName" cssClass="inputBox form-control" cssStyle="width:51%;" maxlength="80"/>
				                                                                    <s:hidden name="warID"/>
				                                                                </td>
				                                                                <td>&nbsp;</td>
				                                                            </tr>
				                                                            <tr>
				                                                                ...
				                                                                <td>
				                                                                    <s:textfield name="warRate" id="warRate" cssClass="inputBox form-control" cssStyle="width:51%;" maxlength="6" onkeypress="return fun_AllowOnlyAmountAndDot(this.id)"/>
				                                                            ...
				                                                            <tr>
				                                                                ...
				                                                                <td>
				                                                                    <s:textfield name="code" readonly="" id="code" cssClass="inputBox form-control" cssStyle="width:51%;" maxlength="30"/>
				                                                            ...
				                                                            <tr>
				                                                            	<td>&nbsp;</td> 
																				<td></td>
				                                                                <td colspan="4"><input type="button" class="btn btn-sm btn-danger" value="Back" onclick="fnCall('warratemaster')"/>&nbsp;&nbsp;<s:submit value="Save" cssClass="btn btn-sm btn-success" onclick="return oncheck()"/></td>
