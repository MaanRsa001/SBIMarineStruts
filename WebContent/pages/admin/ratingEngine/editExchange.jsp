 ...
 <style>
    ...
    <div class="easyui-layout" style="width:100%;height:1000px;">
		...
		<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
			<div class="panel panel-primary">
			   <div class="panel-heading"><s:text name="Exchange Master"/></div>
				  <div class="panel-body">
			                                                        ...
			                                                        <tr>
			                                                          ...
			                                                          <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
			                                                            ...
			                                                            <tr>
			                                                                ...
			                                                                <td>
			                                                                <s:select list="exchanges" id="currencyID" name="currencyID" headerKey="-1" headerValue="-- Select --" listKey="CURRENCY_ID" listValue="CURRENCY_NAME" cssClass="inputBoxS form-control" cssStyle="width:51%;" />
			                                                                </td>
			                                                                <td>&nbsp;</td>
			                                                            </tr>
			                                                            <tr>
			                                                                ...
			                                                                <td>
			                                                                    <s:textfield name="exchangeRate" id="exchangeRate" cssClass="inputBox form-control" cssStyle="width:51%;" maxlength="15" onkeypress="return fun_AllowOnlyAmountAndDotSix(this.id)"/>
			                                                            ...
			                                                            <tr>
																			...
																			<td></td>
			                                                                <td colspan="4">
			                                                                    <input type="button" class="btn btn-sm btn-danger" value="Back" onclick="fnCall('exchangemaster')"/>&nbsp;&nbsp;<s:submit value="Save" cssClass="btn btn-sm btn-success" onclick="return oncheck()"/>
			                                                                </td>
			                                                            </tr>
			                                                         </table></td>
			                                                         </tr>
