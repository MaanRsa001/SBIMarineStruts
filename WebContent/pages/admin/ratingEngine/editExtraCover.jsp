...
<style>
    ...
    <div class="easyui-layout" style="width:100%;height:1000px;">
		...
		<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
			<div class="panel panel-primary">
			   <div class="panel-heading"><s:text name="Extra Cover"/></div>
				  <div class="panel-body">
																	...
																	<tr>
																	  ...
																	  <tr>
																			...
																			<s:if test='"edit".equalsIgnoreCase(mode)'>
																				<s:select name="transID" id="transID" cssClass="inputBoxS form-control" cssStyle="width:51%;" list="transports" listKey="MODE_TRANSPORT_ID" listValue="TRANSPORT_DESCRIPTION" headerKey="-1" headerValue="-Select-" disabled="true" />
																				<s:hidden name="transID"/>
																			</s:if>
																			<s:else>
																				<s:select name="transID" id="transID" cssClass="inputBoxS form-control" cssStyle="width:51%;" list="transports" listKey="MODE_TRANSPORT_ID" listValue="TRANSPORT_DESCRIPTION" headerKey="-1" headerValue="-Select-"/>
																			  </s:else>
																			</td>
																			<td>&nbsp;</td>
																		...
																		<tr>
																			...
																			<td>
																			    <s:textfield name="extraCoverName" id="extraCoverName"  cssClass="inputBox form-control" cssStyle="width:51%;"/>
																			</td>
																			<td>&nbsp;</td>
																		...
																		<tr>
																			...
																			<td>
																				<s:textfield name="remarks" id="remarks" cssClass="inputBox form-control" cssStyle="width:51%;"/>
																			</td>
																			<td>&nbsp;</td>
																		...
																		<tr>
																			...
																			<td>
																				<s:textfield name="code" id="code" cssClass="inputBox form-control" cssStyle="width:51%;"/>
																			</td>
																			<td>&nbsp;</td>
																		...
																		<tr>
																			...
																			<td></td>
																			<td colspan="4">
																				<input type="button" class="btn btn-sm btn-danger" value="Back" onclick="fnCall('extracover')"/>&nbsp;&nbsp;<s:submit value="Save" cssClass="btn btn-sm btn-success"/>
																			</td>
																		</tr>
																	 </table></td>
																	 </tr>
