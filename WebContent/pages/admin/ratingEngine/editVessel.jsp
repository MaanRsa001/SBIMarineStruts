...
<style>
    ...
    <div class="easyui-layout" style="width:100%;height:1000px;">
		...
		<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
			<div class="panel panel-primary">
			   <div class="panel-heading"><s:text name="Vessel Master"/></div>
				  <div class="panel-body">
																		...
																		<tr>
																		  ...
																		  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
																			<tr>
																				...
																				<td>
																					<s:textfield name="vesselName" id="vesselName" cssClass="inputBox form-control" cssStyle="width:51%;height:30px;" maxlength="80" onkeyup="allLetter(this);"/>
																				</td>
																				<td>&nbsp;</td>
																			...
																			<tr>
																				...
																				<td>
																					<s:textfield name="vesselClass" id="vesselClass" cssClass="inputBox form-control" cssStyle="width:51%;height:30px;" maxlength="1" onkeyup="allLetter(this);"/>
																			...
																			<tr>
																				...
																				<td>
																					<s:select cssClass="inputSelect form-control" cssStyle="width:51%;height:30px;" name="vesselType" id="vesselType" list="TypeOfVessels" headerKey="" headerValue="-- Select --"  listKey="VESSEL_TYPE" listValue="VESSEL_TYPE"/>
																				</td>
																				<td>&nbsp;</td>
																			...
																			<td><s:textfield name="vesselRate" id="vesselRate" cssClass="inputBox form-control" cssStyle="width:51%;height:30px;" maxlength="5" onkeypress="return isNumberKey(this);"/></td>													
																			<td>&nbsp;</td>													
																			</tr>
																			<tr>
																				<td>&nbsp;</td>
																				...
																				<td>
																					<s:select name="vesselsYear" id="vesselsYear" list="vesselYears" headerKey="" headerValue="-Select-" cssClass="inputSelect form-control" cssStyle="width:51%;height:30px;"  />
																				</td>
																				<td>&nbsp;</td>																
																			</tr>															
																			<tr>
																			...
																			<tr>
																				...
																				<td></td>
																				<td colspan="4">
																					<input type="button" class="btn btn-sm btn-danger" value="Back" onclick="fnCall('vesselmaster')"/>&nbsp;&nbsp;<s:submit value="Save" cssClass="btn btn-sm btn-success" onclick="return oncheck()"/>
																				</td>
