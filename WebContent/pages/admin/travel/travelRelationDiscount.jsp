									...
									<s:iterator value="list" var="list" status="stat">
										<tr>
											...
											<td style="text-align: center;">
		                    					...
		                    					<a type="button" class="btn btn-sm btn-info" href="#" onclick="$('#relationDiscountView<s:property value="#stat.count"/>').modal('show')">View</a>
											</td>
											<td style="text-align: center;">
...
<s:iterator value="list" var="list" status="stat">
	<div id='relationDiscountView<s:property value="#stat.count"/>' class="modal fade" role="dialog">
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title"><s:text name="travel.relation.discount"/></h4>
				</div>
