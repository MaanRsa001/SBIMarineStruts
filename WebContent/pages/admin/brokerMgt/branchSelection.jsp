...
<script type="text/javascript">
if(window.opener.BrokerInfoEdit.branchId.value.length>=1){
	var val=window.opener.BrokerInfoEdit.branchId.value;
...
function fnsubmit(){
	...
	window.opener.BrokerInfoEdit.branchId.value=checkedItems;
	window.close();
}
