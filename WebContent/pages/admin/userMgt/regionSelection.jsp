			...
			<div class="panel-body">
				<table class="table table-bordered tableWidth">
					...
					<tr>
						...
						<th width="75%"> Region Name </th>
					</tr>
					</thead>
					<tbody>
					<s:iterator value="attchedRegionsList" status="stat" var="record">
					<tr>
						<td align="center"> <input type="checkbox"  value="<s:property value="#record.RegionId"/>" id="checkbox<s:property value="#record.RegionId"/>" /> </td>
...
<script type="text/javascript">
if(window.opener.info.attachedregion.value.length>=1){
	var val=window.opener.info.attachedregion.value;
...
function fnsubmit(){
	...
	window.opener.info.attachedregion.value=checkedItems;
	window.close();
}
</script>
</body>
