			...
			<div class="panel-body" >
				<div class="row">
			 		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
				 		...
				 		<div class="tbox">
							<s:select name="brokerId" id="brokerId" list="existingBrokerList" headerKey="" headerValue="---Select---"  listKey="Code" listValue="CodeDescription" onChange="quoteList(this.value);" cssClass="bg-hover inputBoxS tooltipContent select2" data-content="Broker" />
				 		</div>	
			 		</div>
			 	</div>
			 	<br/>
						...
						<tbody>
						   	<s:iterator value="quoteList" var="var" status="stat">
								<tr>
									...
									<td><b><a href="#" onclick="return viewDoc('<s:property value="ProposalNo" />','<s:property value="%{#var.OpenCoverNo}" />','<s:property value="%{#session.user}" />','draft','','0','false');">Draft</a></b></td>
								</tr>
							</s:iterator>
						</tbody>
					 </table>
...
function quoteList(val){
	document.reportForm.action ='quoteRegisterReportReg.action';
