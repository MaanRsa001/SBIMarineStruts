	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<s:text name="label.pendingtoAccept" />
			</div>
						...
						<tbody>
						   	<s:iterator value="quoteList" var="var" status="stat">
								<tr>
									...
									<td><b><a href="#" onclick="draft'<s:property value="%{#var.ProposalNo}" />');">Draft</a></b></td>
								</tr>
							</s:iterator>
						</tbody>
					 </table>
...
function quoteList(val){
	document.reportForm.action ='pendingAcceptReportReg.action';
