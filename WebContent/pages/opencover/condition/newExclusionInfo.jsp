	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<s:if test='!"".equals(type) && type!=null'>
			...
			<div class="panel-heading">
				<s:text name="Exclusion Info" />:&nbsp;&nbsp;&nbsp;<s:property value="coverName"/><span style="float:right;"><s:text name="Proposal Number:" /><s:property value="proposalNo"/></span>
			</div>
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<div class="body">
				    	<div class="row">
						    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<s:if test='exclusionId!=null && exclusionId.size()>0'>
										<table id="ConditionTable" class="table table-bordered-pop" border="2">
											<thead>
												<tr style="color:blue;">
													<th width="5%"><s:text name="label.Sno"/></th>
													<th width="5%"><s:text name="label.exclusionId"/></th>
													<th width="70%"><s:text name="label.exclusionDescription"/></th>
													<th width="20%"><s:text name="label.commodity"/></th>
												</tr>
											</thead>
											<tbody>
												<s:iterator value="exclusionId" var="list"  status="stat">
													<tr>
														<th align="center" width="10%"><s:property value="%{#stat.count}"/>
														<s:checkbox name="exclusioncheck[%{#stat.index}]"   disabled="#disable"  ></s:checkbox>
														</th>
														<th align="left" width="5%">
															<s:property value='exclusionId[#stat.index]' />
															<s:hidden name="exclusionId[%{#stat.index}]"  id="exclusionId[%{#stat.index}]"></s:hidden>
														</th>
														<th align="left" width="70%">
															<s:textarea name="exclusionName[%{#stat.index}]"  id="exclusionName[%{#stat.index}]" cssClass="form-control" cssStyle="width:100%" disabled="#disable"  onkeyup="textLimit(this,2000)"> </s:textarea>
														</th>
						    ...
						    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<s:if test='exclusionId!=null && exclusionId.size()>0'>
										<table id="ConditionTable" class="table table-bordered-pop" border="2">
											...
											<tbody>
												<s:iterator value="exclusionId" var="list"  status="stat">
												<s:if test='"true".equals(exclusioncheck[#stat.index])'>
													<tr>
														<th align="center" width="10%"><s:property value="%{#stat.count}"/>
														</th>
														<th align="left" width="5%">
														...
														<th align="left" width="70%">
															<s:property value='exclusionName[#stat.index]' />
														</th>
...
function fnSubmit(){
	document.Quotation.action = 'exclusionPopupCondition.action';
...
function proceedBtn(){
	document.Quotation.action = 'addExclusionCondition.action';
	document.Quotation.submit();
}
