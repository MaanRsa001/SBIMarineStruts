		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<div class="body">
				    	<div class="row">
						    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<s:if test='clausesId!=null && clausesId.size()>0'>
										<table id="ConditionTable" class="table table-bordered-pop" border="2">
											<thead>
												<tr style="color:blue;">
													<th width="5%"><s:text name="label.Sno"/></th>
													<th width="5%"><s:text name="label.clauseId"/></th>
													<th width="70%"><s:text name="label.clauseDescription"/></th>
													<th width="20%"><s:text name="label.commodity"/></th>
												</tr>
											</thead>
											<tbody>
												<s:iterator value="clausesId" var="list"  status="stat">
													<tr>
														<th align="center" width="10%"><s:property value="%{#stat.count}"/>
														<s:checkbox name="clausescheck[%{#stat.index}]"   disabled="#disable"  ></s:checkbox>
														</th>
														<th align="left" width="5%">
															<s:property value='clausesId[#stat.index]' />
															<s:hidden name="clausesId[%{#stat.index}]"  id="clausesId[%{#stat.index}]"></s:hidden>
														</th>
														<th align="left" width="70%">
															<s:textarea name="clausesName[%{#stat.index}]"  id="clausesName[%{#stat.index}]" cssClass="form-control" cssStyle="width:100%" disabled="#disable"  onkeyup="textLimit(this,2000)"> </s:textarea>
														</th>
						    ...
						    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<s:if test='clausesId!=null && clausesId.size()>0'>
										<table id="ConditionTable" class="table table-bordered-pop" border="2">
											...
											<tbody>
												<s:iterator value="clausesId" var="list"  status="stat">
												<s:if test='"true".equals(clausescheck[#stat.index])'>
													<tr>
														<th align="center" width="10%"><s:property value="%{#stat.count}"/>
														</th>
														<th align="left" width="5%">
														...
														<th align="left" width="70%">
															<s:property value='clausesName[#stat.index]' />
														</th>
...
function fnSubmit(){
	document.Quotation.action = 'addClausesCondition.action';
	document.Quotation.submit();
}
</script>	
</body>
